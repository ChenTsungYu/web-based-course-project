    ...
    <div class="box box-warning">
      <form action="" method="post" name="">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div align="left">
                ...
                <input type="submit" name="datefilterBtn" value="日期篩選" class="btn btn-success">
          ...
          <br>
          <?php
            $select = $pdo->prepare("select sum(total) as total , sum(subtotal) as stotal,count(invoice_id) as invoice from tb_invoice  where order_date between :fromdate AND :todate");
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">所有單據</span>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">小計</span>
                  <span class="info-box-number">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">總額</span>
                  <span class="info-box-number">
